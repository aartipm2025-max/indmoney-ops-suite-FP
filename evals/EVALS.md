...
**Questions:** 35
**Pass Rate:** 12/35 (34.3%)
**Avg Faithfulness:** 0.31/1.0
**Avg Relevance:** 0.37/1.0
...
| Q003 | What is the expense ratio of SBI Small Cap Fund?... | 0.0 | 0.0 | ERROR |
| Q004 | What is the minimum SIP for SBI ELSS Tax Saver Fun... | 1.0 | 1.0 | PASS |
| Q005 | Who is the fund manager of SBI Midcap Fund?... | 0.0 | 0.0 | ERROR |
| Q006 | What is exit load and how is it calculated?... | 0.0 | 0.0 | ERROR |
| Q007 | What is the benchmark for SBI Large Cap Fund?... | 1.0 | 1.0 | PASS |
| Q008 | What is the exit load for SBI Equity Hybrid Fund a... | 0.0 | 0.0 | ERROR |
| Q009 | What are the top holdings of SBI Bluechip Fund?... | 0.0 | 0.0 | ERROR |
| Q010 | What is the taxation on ELSS fund redemptions?... | 0.5 | 1.0 | PASS |
